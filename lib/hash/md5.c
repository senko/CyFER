...
void CYFER_MD5_Init(MD5_CTX *ctx)
{
...
void CYFER_MD5_Finish(MD5_CTX *ctx, unsigned char *md)
{
...
void CYFER_MD5_Update(MD5_CTX *ctx, const unsigned char *data, size_t len)
{
	while (len--) {
...
void CYFER_MD5(const unsigned char *data, size_t len, unsigned char *md)
{
	MD5_CTX ctx;
